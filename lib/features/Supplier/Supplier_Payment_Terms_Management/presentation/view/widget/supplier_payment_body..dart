...
import '../../view_model/Supplier_Payment_model.dart';
class SupplierPaymentBody extends StatefulWidget {
  @override
  _SupplierPaymentBodyState createState() => _SupplierPaymentBodyState();
}

class _SupplierPaymentBodyState extends State<SupplierPaymentBody> {
  List<SupplierPaymentTermModel> customerAccounts = [
