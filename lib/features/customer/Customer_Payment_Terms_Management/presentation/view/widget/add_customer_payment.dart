...
class AddCustomerPayment extends StatefulWidget {
  @override
  _AddCustomerPaymentState createState() => _AddCustomerPaymentState();
}

class _AddCustomerPaymentState extends State<AddCustomerPayment> {
